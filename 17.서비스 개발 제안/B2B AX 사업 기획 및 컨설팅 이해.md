...
1. 개발에 필요한 작업자를 업무 구분에 리스트업 함 
    - 필요한 인력 확인
2. 업무를 분석하면서 필요한 인력에 대한 점검 및 역할 구분
3. 개발 기간에 대한 산정
    - 고객 기준 일정
    - 개발 기준 최소 일정
4. 실제 투입될 투입 공수를 작성
5. 투입되는 개발자의 등급별 단가 (매입 기준)
6. 최종 비용 자동 계산
    - 위의 숫자들을 개발과 검토하며 조정해가며 최종 원가 산정

- 개발 능력에 따라 달라질 수 있음
- 개발 총괄과 상의하여 개발 인력 변동될 수 있음
- FP(Function Point / 기능 중심) 기준으로 생각할 것

![개발 투입 인력 계획](image/개발투입인력계획.png "개발 투입 인력 계획")

--------------------------------------------------------

#### [ 비용 취합 ]

- 전체 리스트업을 할 때 반드시 개발의 검토를 받아야 함

![비용 취햡](image/비용취합.png "비용취합")

-----------------------------------------------------------------

#### [ 비용 산정과 관련된 정보 ]

**사업 발주 단계에서 아래의 요소로 인해 정확한 개발 비용 산정은 불가능**

1. 기능사항 분석의 한계
    - 실제 프로젝트 진행 중. 상세 분석 설계를 전에 비용 산정을 하기 위한 정확한 기능 정의 불가
2. 개발 역량의 차이
    - 개발은 개발자 혹은 회사의 역량에 따라서 Output이 정말 차이가 큼
        - 잘 하는 사람 1일. 못하는 사람 7일
        - 개발 비용은 인건비 기준
3. 요구사항의 변동성
    - 발주 시 대략적 개발 요구 사항은. 프로젝트 진행 중 계속 변화함
        - IT 20년 이상. PM 10년 이상 경험자의 말

**< 중요한 것은 정확한 비용이 아니라, 크게 틀리지 않는 대략적 비용 산정 후 적절히 대응하는 컨셉 >**

1. 앞서 설명한 방식으로 정확한 비용 산정
2. 비용에 대한 원가 취합 후 분석 (매입원가)
3. 고객이 제공해 줄 수 있는 비용 분석 (매출원가)
4. 매출원가와 매입원가 기반 수익률 계산
5. 계산된 수익률을 보고, 사업 참여 여부 혹은 서비스 조절을 통한 진행
...
- **기본 문서 서식**
- **서비스 구성도 + 시스템 구성도**
    - 고객님의 요청 해결을 위한 전체 서비스가 이런 식으로 구성됩니다
- **핵심 서비스 구현 상세 자료**
    - 
- **비용 및 일정 정보 ( 필요시 )**
- **요구 사항에 따른 주요 제공 기능 리스트업 (필요시), RFI 초안**

### 2. 고객 제안

**우리 회사의 제품(서비스 or 솔루션)이 고객에게 필요한 이유를 작성**


#### 고객에게 제안하는 IT 서비스 기획 자료 작성 방법

**1. 자사 제품(서비스 or 솔루션) 기능 및 장단점 분석**
- 회사가 보유한 제품에 대한 상세한 분석을 통해, 제품이 가진 기능과 장단점, 제약, 특장점 등을 명확히 이해
- 산업에 대하여가 아닌 자사 제품에 대하여

**2. 핵심 기능 사항 기획 자료 작성**
- 자사 제품 분석을 통해서, 자사 제품의 핵심 기능과 장점 등을 정리한 기획 자료 작성

**3. 시장 분석 ( 고객 분석 및 경쟁자 분석 )** 
- 시장에서 해당 제품을 필요로 하는 고객 군을 찾아내는 작업
- 타겟 고객을 찾아내과 해당 **[ 고객이 제품을 구매에야 하는 이유 ]** 에 대해 분석 정리
- 시장의 경쟁자를 찾아내 **[ 경쟁자 대비 강점 ]**을 분석
...
**2. 고객 분석**
- 제품을 사용할 고객 분석
    - 대상 고객이 누구이며, 어떤 Pain Point를 가지고 있고. 어떻게 해결 해야 할지?

**3. 경쟁자 분석**
- 제품의 경쟁자 분석
    - 우리 제품의 경쟁자가 어떻게 있으며. 포지셔닝 전략을 어떻게 가져가고. 어떤 강점을 만들어 갈지?
...
**2. 해결 방안**
- Pain Point 해결 방안
    - 그 문제를 해결하려면 이런 방법이 필요합니다
        - 전자 문서 시스템이 좋습니다

**3. 제안 서비스**
- 자사 제품 제안
    - 저희 제품이 그 문제를 해결해 드리는데, 이런 핵심 기능을 가지고 있습니다.
        - 저희는 위변조 방지 기술이 특출나고, pdf도 변환 없이 원본 기준으로 작업할 수 있습니다.

**4. 기대 효과**
- 제품 이용에 따른 효과
    - 저희 제품을 통해 문제를 해결하시면, 이러한 기대효과를 가져갈 수 있습니다
        - 전자화를 통해 종이를 보관하던 창고 등을 다른 공간으로 활용할 수 있습니다

**5. 추진 전략**
- 진행을 위한 방법
    - 어떻게 하면 진행을 할 수 있을지 설명하겠습니다
...
![제안 배경](image/제안배경.png "제안 배경")

-----------------------------------------------------

**[ 해결 방안 ]**

- 현재 상황과 개선 방안을 제시함으로써 고객에게 문제 상황을 인식시킴

![해결 방안](image/해결방안.png "해결 방안")
...
- 개선 사항, 기대 효과를 확실히 설명
- 가능한 직관적인 효과 및 정량적 효과를 제공하는 것이 좋음
    - 무엇이 얼마나(몇퍼센트) 개선된다

![기대 효과](image/기대효과.png "기대 효과")
...
![추진 전략](image/추진전략.png "추진 전략")

--------------------------------------------

#### [ 서비스 제안 기본 자료 목차 ]

**1. 기본 문서 서식 (표지, 개정이력, 목차)**

**2. 회사( 제안사 ) 소개**
- 저희 회사는 이런 회사인데 이런 부분에 경쟁력이 높은 회사입니다

**제품 ( 제안 ) 개요**
- 지금 고객님이 갖고 있는 문제 **[ Pain Point ]** 를 해결해 드릴 좋은 방법과 시스템을 소개 드립니다. 도입하면 분명 이득입니다.

**주요 서비스 ( 핵심 서비스 기능 + 경쟁사 대비 강점 / 차별화 )**
- 더 자세히 설명해 드릴 깨요. 이런 기능들을 통해서 고객님의 문제를 확실히 이런 방식으로 해결해 드릴 수 있습니다.
- 그리고 저희는 경쟁자 들에 비해서 이런 부분에서 명확히 좋은 강점을 가지고 있어서. 반드시 저희를 선택 하시는 게 좋습니다.