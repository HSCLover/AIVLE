...
### [ 전통적인 필요 요소 ]
![alt text](LegacyNeeds.png)

------------------------------------------------

### [ 현재 트랜드 ]
![alt text](PresentTrend.png)
...
![alt text](BusinessOperationsAndHR.png)
